...
var joinWith = function (dictFoldable) {
    return function (splice) {
        return function ($78) {
            return Data_Foldable.intercalate(dictFoldable)(Data_Monoid.monoidString)(splice)(Unsafe_Coerce.unsafeCoerce($78));
        };
    };
};
...
var fromFoldable1 = function (dictFoldable1) {
    return function ($84) {
        return Data_Semigroup_Foldable.fold1(dictFoldable1)(semigroupNonEmptyString)(Unsafe_Coerce.unsafeCoerce($84));
    };
};
