        ...
        return function (dictUnfoldable) {
            return function (gen) {
                var unfold = function (v) {
                    ...
                    throw new Error("Failed pattern match at Control.Monad.Gen line 98, column 12 - line 100, column 35: " + [ v.constructor.name ]);
                };
                ...
                return Data_Functor.map((((dictMonadGen.Monad0()).Bind1()).Apply0()).Functor0())(Data_Unfoldable.unfoldr(dictUnfoldable)(unfold))(Control_Monad_Gen_Class.sized(dictMonadGen)(function ($62) {
                    return Control_Monad_Rec_Class.tailRecM(dictMonadRec)(loopGen)(Data_Tuple.Tuple.create(Nil.value)($62));
                }));
            };
        };
    };
...
var fromIndex = function (dictFoldable) {
    return function (i) {
        return function (a) {
            ...
            return function ($63) {
                return Data_Maybe.fromMaybe(a)(Data_Tuple.snd(Data_Foldable.foldl(dictFoldable)(go)(new Data_Tuple.Tuple(0, new Data_Maybe.Just(a)))($63)));
            };
        };
    };
};
...
var frequency = function (dictMonadGen) {
    return function (dictFoldable) {
        return function (v) {
            var pick = function (pos) {
                var go = function (v1) {
                    return function (v2) {
                        var nextWeight = v1.value0 + v2.value0;
                        var $49 = v1.value0 <= pos && pos <= nextWeight;
                        if ($49) {
                            return new Data_Tuple.Tuple(nextWeight, v2.value1);
                        };
                        return new Data_Tuple.Tuple(nextWeight, v1.value1);
                    };
                };
                var initial = go(Data_Tuple.Tuple.create(0.0)(Data_Tuple.snd(v.value0)))(v.value0);
                return Data_Tuple.snd(Data_Foldable.foldl(dictFoldable)(go)(initial)(v.value1));
            };
            ...
            return Control_Bind.bind((dictMonadGen.Monad0()).Bind1())(Control_Monad_Gen_Class.chooseFloat(dictMonadGen)(0.0)(total))(pick);
        };
    };
};
